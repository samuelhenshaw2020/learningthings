...
@NgModule({
  declarations: [AnalysisComponent, DashboardComponent, SettingsComponent, AccountsComponent, WebsitesComponent, PaymentComponent, AdminMailComponent, SubDatePipe],
  imports: [
    CommonModule,
    AdminRoutingModule,
    MatDividerModule,
  ...
  entryComponents: [AdminMailComponent],
